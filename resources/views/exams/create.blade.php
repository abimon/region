                ...
                <tr>
                    ...
                    <td>
                        <div class="form-floating m-3">
                            <input type='text' name="ch{{$user->id}}" placeholder=" " class="form-control">
                            <label for="">Church Heritage</label>
                        </div>
                    </td>
                    <td>
                        <div class="form-floating m-3">
                            <input type='text' name="bt{{$user->id}}" placeholder=" " class="form-control">
                            <label for="">Bible Truth</label>
                        </div>
                    </td>
                    <td>
                        <div class="form-floating m-3">
                            <input type='text' name="gk{{$user->id}}" placeholder=" " class="form-control">
