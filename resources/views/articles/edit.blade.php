@extends('layouts.app', ['title' => 'Edit Article'])
@section('content')
<div class="container">
    <form action="{{route('articles.update', $article->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="ms-2 card p-3 border-dark bg-transparent shadow h-75" style="border-style:dashed;">
                        <img id="outCard" src="{{ $article->image }}" style="height: 100%; object-fit:contain;" />
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category" id="" class="form-select text-dark bg-white" required>
                            ...
                            <option value="{{$option}}" {{ $article->category == $option ? 'selected' : '' }}>{{$option}}</option>
                            @endforeach
                        </select>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="post" name="content" rows="3">{{ $article->content }}</textarea>
                @error('content')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
